...
import com.zhaoxi.Open_source_Android.web3.exceptions.MessageDecodingException;
import com.zhaoxi.Open_source_Android.web3.exceptions.MessageEncodingException;
...
public final class Numeric {
    ...
    public static boolean isValidAddress(String input) {
        ...
        return cleanInput.length() == DAppConstants.ADDRESS_SIZE;
    }
