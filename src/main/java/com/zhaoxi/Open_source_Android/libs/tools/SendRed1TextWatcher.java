...
public class SendRed1TextWatcher implements TextWatcher {
    ...
    public SendRed1TextWatcher(Context context, int type, Button button,
...
//            mTxtShowMoney.setText(ssTol);
        ...
        if (!"".equals(text)) {
            if (mRedType == 1) {//普通
                ...
                if ((Float.valueOf(text) >= 100 && text.contains(".")) || (Float.valueOf(text) > 100 && !text.contains("."))) {
                ...
                if ((Float.valueOf(text) >= 10000 && text.contains(".")) || (Float.valueOf(text) > 10000 && !text.contains("."))) {
