...
public class GetNodeBalanceRequest extends BaseOkHttpRequest {
    private String mAddress;

    public GetNodeBalanceRequest(String address) {
    ...
    protected String toRequestURL() {
        return UrlContext.Url_NodeBounsBalance.getContext();
    }
